...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
                            ...
                            .requestLocationUpdates(locationRequest, new LocationCallback() {
                                ...
                                public void onLocationResult(@NonNull LocationResult locationResult) {
                                    ...
                                    if (locationResult != null && locationResult.getLocations().size() >0){
                                        ...
                                        mMap.addMarker(new MarkerOptions().position(posicionActual).title("Posición actual"));
        ...
        result.addOnCompleteListener(new OnCompleteListener<LocationSettingsResponse>() {
            ...
            public void onComplete(@NonNull Task<LocationSettingsResponse> task) {
                ...
                try {
                    ...
                    Toast.makeText(MapsActivity.this, "El GPS ya está activo.", Toast.LENGTH_SHORT).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        /*LatLng sevilla = new LatLng(latitude, longitude);
